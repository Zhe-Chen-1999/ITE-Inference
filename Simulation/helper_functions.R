...
################################################################################
# M1: Method in Caughey et al. (2023) 
# M2: Method combining treated and control using Bonferroni correction (apply M0 twice)
# M3: Method using Berger and Boos (1994)'s approach
